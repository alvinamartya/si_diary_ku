            ...
            db
                    ...
                    .addOnCompleteListener(task -> {
                        if (task.isSuccessful()) {
                            ...
                            DiaryEntity diaryEntity = new DiaryEntity(id, newDiaryModel.getAddress(), date, newDiaryModel.getDiary(), "", newDiaryModel.getTagList(), progres);
                            DiaryDao.addDiaryLiveData(diaryEntity);
